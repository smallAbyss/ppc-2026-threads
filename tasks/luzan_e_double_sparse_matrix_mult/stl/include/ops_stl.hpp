...
class LuzanEDoubleSparseMatrixMultStl : public BaseTask {
 public:
  ...
  static void AssembleResult(SparseMatrix &c, unsigned cols,
                                                              const std::vector<std::vector<double>> &values_per_col,
                                                              const std::vector<std::vector<unsigned>> &rows_per_col);
  static void ProcessColumn(const SparseMatrix &a, const SparseMatrix &b,
                                                             unsigned b_col,
  ...
  static void AccumulateColumn(const SparseMatrix &a, const SparseMatrix &b,
                                                                unsigned b_col, std::vector<double> &tmp_col);
